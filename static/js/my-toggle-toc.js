var docsifyToggleToc = new Object();
// DOM内容加载完成后执行
window.addEventListener('DOMContentLoaded', function () {

    // 4. 封装函数docsifyToggleTocFn()
    // 4.1 调用函数
    docsifyToggleTocFn(docsifyToggleToc);
    // 4.2 封装函数
    function docsifyToggleTocFn({
        ...
        div.addEventListener('click', function () {
            pageToc = document.getElementsByClassName("page_toc")[0]
            console.log(pageToc)
            console.log("pageToc.style.display=", pageToc.style.display)

            if (pageToc.style.display !== 'none') {
